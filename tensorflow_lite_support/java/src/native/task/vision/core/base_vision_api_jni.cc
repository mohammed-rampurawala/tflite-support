...
Java_org_tensorflow_lite_task_vision_core_BaseVisionApi_createFrameBufferFromByteBuffer(
...
extern "C" JNIEXPORT jlong JNICALL
Java_org_tensorflow_lite_task_vision_core_BaseVisionApi_createFrameBufferFromBytes(
...
Java_org_tensorflow_lite_task_vision_core_BaseVisionApi_deleteFrameBuffer(
